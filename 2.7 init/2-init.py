...
Вася улучшает свою соцсеть Person. При создании странички, пользователь указывает обязательные данные, и нажимая на кнопку "создать", создаётся страница с данными пользователя.
