...
К сожалению, на Stepik нет модуля accessify. Поэтому задание выполните у себя на компьютере, например в PyCharm. 
    Часть кода уже написана, сюда вставьте ваш код из PyCharm, но без импорта модуля и без декоратора. 
    Либо закомментируйте импорт и декоратор. Не забывайте про self и скобки при вызове методов.
Sample Input:
Sample Output:
Активатор от телепорта у Машеньки под подушкой
"""
