...
Вася решил закрепить свои знания по статическим методам, взяв разного рода задачки по математике. Для этого он взял пример подсчёта времени относительно скорости и расстояния.
